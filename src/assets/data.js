...
export const links = [
  ...
  (pathname === "/dashboard" || pathname === "/login") && {
    icon: pathname === "/dashboard" ? Icons.links.Dashboard : Icons.links.Login,
    text: pathname === "/dashboard" ? "dashboard" : "login",
    path: pathname === "/dashboard" ? "/dashboard" : "/login",
  },
];
