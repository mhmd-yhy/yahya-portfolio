...
const ServicesContainer = () => {
  const [servicesData, setServicesData] = useState(services.service);
  return (
    <div>
          ...
          <table className=" border-separate border-spacing-2 border our-border-color our-border-color  ">
            {servicesData.length < 4 &&
              <caption class="caption-top text-start ">
                For add new service <span className='text-blue-600 cursor-pointer'>Click..</span>
              </caption>
            }
            ...
            <tbody>
              {servicesData?.map((service, i) => <tr>
                <td className='border our-border-color text-center px-1' >{i + 1}</td>
                <td className='border our-border-color text-center px-1 text-sm lg:text-base' >{service.title}</td>
                <td className='border our-border-color text-blue-600 text-3xl '><span className='flex justify-center'>{service.icon}</span></td>
