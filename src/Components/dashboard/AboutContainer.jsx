  ...
  return (
    <div>
      ...
      <div className="dark:text-Text-Color-Dark">
        <textarea
          rows={5}
          className="w-full bg-Third-Back-Light dark:bg-Back-Dark outline-none"
          value={aboutDesc}
          onChange={(e) => setAboutDesc(e.target.value)}
        />
        <div className="flex items-center gap-5">
          <button onClick={edit_About} className="bg-blue-500 text-zinc-200 text-lg tracking-wide my-2 py-2 px-4 rounded-lg capitalize">
            edit
          </button>
